...
const UserHistory = ({darkMode, setDarkMode}) => {
  ...
  return (
    <>
      <div class={`px-8 pt-4 sm:ml-28 flex flex-col ${darkMode ? "bg-gray-900 text-white scroll-bar" : "bg-white text-gray-900"}`}>
        <div className="chevron-pattern rounded-xl p-3 mb-3 drop-shadow-lg animate__animated animate__fadeIn animate__slower">
          <div className="flex flex-row justify-self-center space-x-2 items-center transition-opacity duration-700 fade-in-out">
            ...
            {/* <h1 className={`text-7xl font-rubik font-bold ${darkMode ? "text-black" : "text-white"}`}>
              History
            </h1> */}
          </div>
        </div>

        {/* <div class="p-8 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 h-[61vh] overflow-y-auto">
          {loading ? (
